...
<head>
  ...
  <title>Perpustakaan Wikrama - Index</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">WIKRAMABOOK</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>There's nothing more fun than exploring the library</h1>
          <h2>Accessible online and free!</h2>
